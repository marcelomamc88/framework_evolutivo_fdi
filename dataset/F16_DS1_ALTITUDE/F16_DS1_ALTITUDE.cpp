...
#define S_FUNCTION_NAME F16_DS1_ALTITUDE
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    //Load Hopsan model
    const char* hmfFilePath = "F16_DS1_ALTITUDE.hmf";
...
static void mdlStart(SimStruct *S)
{
    ...
    pInputNode3 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Input_Fault_Beta_Amplitude")->getSafeNodeDataPtr("out", 0);
    pInputNode4 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Input_Fault_Beta_Time")->getSafeNodeDataPtr("out", 0);
    ...
    pOutputNode3 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Flow_Chamber2_CilindA")->getSafeNodeDataPtr("in", 0);
    pOutputNode4 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Flow_Chamber2_CilindB")->getSafeNodeDataPtr("in", 0);
    pOutputNode5 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Flow_PressureLine_LeftAilC1")->getSafeNodeDataPtr("in", 0);
    pOutputNode6 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Flow_PressureLine_LeftAilC2")->getSafeNodeDataPtr("in", 0);
    pOutputNode7 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Flow_Tank_LeftAilC1")->getSafeNodeDataPtr("in", 0);
    pOutputNode8 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Flow_Tank_LeftAilC2")->getSafeNodeDataPtr("in", 0);
    pOutputNode9 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Force_CilindA")->getSafeNodeDataPtr("in", 0);
    pOutputNode10 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Force_CilindB")->getSafeNodeDataPtr("in", 0);
    pOutputNode11 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Position_CilindA")->getSafeNodeDataPtr("in", 0);
    pOutputNode12 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Position_CilindB")->getSafeNodeDataPtr("in", 0);
    pOutputNode13 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Pressure_Chamber1_CilindA")->getSafeNodeDataPtr("in", 0);
    pOutputNode14 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Pressure_Chamber1_CilindB")->getSafeNodeDataPtr("in", 0);
    pOutputNode15 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Pressure_Chamber2_CilindA")->getSafeNodeDataPtr("in", 0);
    pOutputNode16 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Pressure_Chamber2_CilindB")->getSafeNodeDataPtr("in", 0);
    pOutputNode17 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Pressure_PressureLine_LeftAilC1")->getSafeNodeDataPtr("in", 0);
    pOutputNode18 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Pressure_PressureLine_LeftAilC2")->getSafeNodeDataPtr("in", 0);
    pOutputNode19 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Pressure_Tank_LeftAilC1")->getSafeNodeDataPtr("in", 0);
    pOutputNode20 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Pressure_Tank_LeftAilC2")->getSafeNodeDataPtr("in", 0);
    pOutputNode21 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Torque")->getSafeNodeDataPtr("in", 0);
    pOutputNode22 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Velocity_CilindA")->getSafeNodeDataPtr("in", 0);
    pOutputNode23 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_Velocity_CilindB")->getSafeNodeDataPtr("in", 0);
    pOutputNode24 = pComponentSystem->getSubComponentSystem("Subsystem")->getSubComponentSystem("Left_Airleron")->getSubComponent("Output_y_servo_valve")->getSafeNodeDataPtr("in", 0);
