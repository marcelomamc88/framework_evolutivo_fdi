...
#define S_FUNCTION_NAME Left_Airleron
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (!ssSetNumInputPorts(S,9)) return;				//Number of input signals
    ...
    //Load Hopsan model
    const char* hmfFilePath = "untitled.hmf";
    ...
    if (pComponentSystem==0)
    {
        ...
        ssSetErrorStatus(S,"Error could not open model: untitled.hmf");
        return;
    }
    pComponentSystem->setDesiredTimestep(0.001);

    //Setup block mask (e.g. update icon, graphics etc for Simulink block)
    mexCallMATLAB(0, 0, 0, 0, "Left_AirleronMaskSetup"); //Run the port label script
}
...
static void mdlStart(SimStruct *S)
{
    ...
    pInputNode0 = pComponentSystem->getSubComponent("Input_Fault_Beta_Amplitude")->getSafeNodeDataPtr("out", 0);
    pInputNode1 = pComponentSystem->getSubComponent("Input_Fault_Beta_Time")->getSafeNodeDataPtr("out", 0);
    pInputNode2 = pComponentSystem->getSubComponent("Input_Fault_Bp_Amplitude")->getSafeNodeDataPtr("out", 0);
    pInputNode3 = pComponentSystem->getSubComponent("Input_Fault_Bp_Time")->getSafeNodeDataPtr("out", 0);
    pInputNode4 = pComponentSystem->getSubComponent("Input_Fault_c_leak_Amplitude")->getSafeNodeDataPtr("out", 0);
    pInputNode5 = pComponentSystem->getSubComponent("Input_Fault_c_leak_Time")->getSafeNodeDataPtr("out", 0);
    pInputNode6 = pComponentSystem->getSubComponent("Input_Valve_Fault_Amplitude_CilindA")->getSafeNodeDataPtr("out", 0);
    pInputNode7 = pComponentSystem->getSubComponent("Input_Valve_Fault_Fixed_Position_CilindA")->getSafeNodeDataPtr("out", 0);
    pInputNode8 = pComponentSystem->getSubComponent("Input_Valve_Fault_Time_CilindA")->getSafeNodeDataPtr("out", 0);
    pOutputNode0 = pComponentSystem->getSubComponent("Output_Angle")->getSafeNodeDataPtr("in", 0);
    pOutputNode1 = pComponentSystem->getSubComponent("Output_Flow_Chamber1_CilindA")->getSafeNodeDataPtr("in", 0);
    pOutputNode2 = pComponentSystem->getSubComponent("Output_Flow_Chamber1_CilindB")->getSafeNodeDataPtr("in", 0);
    pOutputNode3 = pComponentSystem->getSubComponent("Output_Flow_Chamber2_CilindA")->getSafeNodeDataPtr("in", 0);
    pOutputNode4 = pComponentSystem->getSubComponent("Output_Flow_Chamber2_CilindB")->getSafeNodeDataPtr("in", 0);
    pOutputNode5 = pComponentSystem->getSubComponent("Output_Flow_PressureLine_LeftAilC1")->getSafeNodeDataPtr("in", 0);
    pOutputNode6 = pComponentSystem->getSubComponent("Output_Flow_PressureLine_LeftAilC2")->getSafeNodeDataPtr("in", 0);
    pOutputNode7 = pComponentSystem->getSubComponent("Output_Flow_Tank_LeftAilC1")->getSafeNodeDataPtr("in", 0);
    pOutputNode8 = pComponentSystem->getSubComponent("Output_Flow_Tank_LeftAilC2")->getSafeNodeDataPtr("in", 0);
    pOutputNode9 = pComponentSystem->getSubComponent("Output_Force_CilindA")->getSafeNodeDataPtr("in", 0);
    pOutputNode10 = pComponentSystem->getSubComponent("Output_Force_CilindB")->getSafeNodeDataPtr("in", 0);
    pOutputNode11 = pComponentSystem->getSubComponent("Output_Position_CilindA")->getSafeNodeDataPtr("in", 0);
    pOutputNode12 = pComponentSystem->getSubComponent("Output_Position_CilindB")->getSafeNodeDataPtr("in", 0);
    pOutputNode13 = pComponentSystem->getSubComponent("Output_Pressure_Chamber1_CilindA")->getSafeNodeDataPtr("in", 0);
    pOutputNode14 = pComponentSystem->getSubComponent("Output_Pressure_Chamber1_CilindB")->getSafeNodeDataPtr("in", 0);
    pOutputNode15 = pComponentSystem->getSubComponent("Output_Pressure_Chamber2_CilindA")->getSafeNodeDataPtr("in", 0);
    pOutputNode16 = pComponentSystem->getSubComponent("Output_Pressure_Chamber2_CilindB")->getSafeNodeDataPtr("in", 0);
    pOutputNode17 = pComponentSystem->getSubComponent("Output_Pressure_PressureLine_LeftAilC1")->getSafeNodeDataPtr("in", 0);
    pOutputNode18 = pComponentSystem->getSubComponent("Output_Pressure_PressureLine_LeftAilC2")->getSafeNodeDataPtr("in", 0);
    pOutputNode19 = pComponentSystem->getSubComponent("Output_Pressure_Tank_LeftAilC1")->getSafeNodeDataPtr("in", 0);
    pOutputNode20 = pComponentSystem->getSubComponent("Output_Pressure_Tank_LeftAilC2")->getSafeNodeDataPtr("in", 0);
    pOutputNode21 = pComponentSystem->getSubComponent("Output_Torque")->getSafeNodeDataPtr("in", 0);
    pOutputNode22 = pComponentSystem->getSubComponent("Output_Velocity_CilindA")->getSafeNodeDataPtr("in", 0);
    pOutputNode23 = pComponentSystem->getSubComponent("Output_Velocity_CilindB")->getSafeNodeDataPtr("in", 0);
    pOutputNode24 = pComponentSystem->getSubComponent("Output_y_servo_valve")->getSafeNodeDataPtr("in", 0);
